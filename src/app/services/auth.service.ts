...
import {ClientLogin, ClientLoginWithFacebook} from '../model/client';
...
export class AuthService {
    ...
    loginWithFacebook(client: ClientLoginWithFacebook): Observable<any> {
        return this.httpClient.post(`${environment.backend}/api/users/loginFacebook`, client).pipe(
            map((res: any) => {
